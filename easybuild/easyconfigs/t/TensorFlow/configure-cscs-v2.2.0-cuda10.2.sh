...
echo "10.2" >> $CONF_IN   # Please specify the CUDA SDK version you want to use. [Leave empty to default to CUDA 10]:
echo "8.0.2" >> $CONF_IN  # Please specify the cuDNN version you want to use. [Leave empty to default to cuDNN 7]:
echo "2.7.8" >> $CONF_IN  # Please specify the locally installed NCCL version you want to use. [Leave empty to use http://github.com/nvidia/nccl]:
...
# echo "10.2" >> $CONF_IN # Please specify the CUDA SDK version you want to use
# echo "8.0.2" >> $CONF_IN # Please specify the cuDNN version you want to use.
# echo "2.7.8" >> $CONF_IN # Please specify the NCCL version you want to use.
